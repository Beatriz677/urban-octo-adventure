...
let totalNumberOfAnimals = numberOfDogs + numberOfCats + numberOfTurtles + numberOfHamsters + numberOffish

let totalNumberOfMammals = numberOfDogs + numberOfCats + numberOfHamsters

let totakNumberOfAnimals = 6 + 5 + 2 + 1 + 2
//16
let totakNumberOfMammals = 6 + 5 + 1
//12
