...
let totalOfMinutes = brushTeeth + writeNovel + chooseClothes + shower + finishHomework
...
let totalOfIDontWantToDo = finishHomework + writeNovel
let totalOfIWantToDo = brushTeeth + chooseClothes + shower
